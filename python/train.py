...
def getTrainDataSet(): 
    rawdata = pd.read_csv('data.csv', names=['e','E','nanoparticle_charge','counterion_valency','total_gridpoints','cpmd_fake_mass','fake_temperature','R','R_v','FD','output','Time'])
...
def predict():    
    rawdata = pd.read_csv('test_data.csv', names=['e','E','nanoparticle_charge','counterion_valency','total_gridpoints','cpmd_fake_mass','fake_temperature','R','R_v','FD','output','Time'])
    rawdata=rawdata.drop(rawdata.index[0])
