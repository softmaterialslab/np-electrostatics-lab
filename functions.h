...
inline void write_basic_files(int write, int cpmdstep, vector<PARTICLE>& ion, vector<VERTEX>& s, vector<THERMOSTAT>& real_bath, vector<THERMOSTAT>& fake_bath, INTERFACE& dsphere)
{
  ...
  list_position << cpmdstep << setw(15) << ion[0].posvec.GetMagnitude() << setw(15) << ion[1].posvec.GetMagnitude() << setw(15) << ion[2].posvec.GetMagnitude() << endl; 
  list_velocity << cpmdstep << setw(15) << ion[0].velvec.GetMagnitude() << setw(15) << ion[1].velvec.GetMagnitude() << setw(15) << ion[2].velvec.GetMagnitude() << endl; 
  list_force << cpmdstep << setw(15) << ion[0].forvec.GetMagnitude() << setw(15) << ion[1].forvec.GetMagnitude() << setw(15) << ion[2].forvec.GetMagnitude() << endl; 
  list_fake << cpmdstep << setw(15) << s[0].w << setw(15) << s[0].vw << setw(15) << s[0].fw << endl;
  list_bath << cpmdstep << setw(15) << real_bath[0].xi << setw(15) << real_bath[0].eta << setw(15) << fake_bath[0].xi << setw(15) << fake_bath[0].eta << endl;
  return;
}
